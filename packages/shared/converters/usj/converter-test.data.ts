  ...
  content: [
    {
      ...
      content: [
        "Some ",
        { type: "ms", marker: "zmsa-s" },
        "marked",
        { type: "ms", marker: "zmsa-e" },
        " text.",
      ],
    },
    {
      ...
      content: [
        "Some ",
        { type: "ms", marker: "zmsa-s", sid: "1" },
        "overlapping",
        { type: "ms", marker: "zmsa-s", sid: "2" },
        "marked",
        { type: "ms", marker: "zmsa-e", eid: "1" },
        " text.",
        { type: "ms", marker: "zmsa-e", eid: "2" },
      ],
    },
    {
      type: "para",
    ...
    children: [
      {
        ...
        children: [
          ...
          { type: "ms", marker: "zmsa-s", version: 1 },
          {
            type: "mark",
            ids: [],
            direction: null,
          ...
          { type: "ms", marker: "zmsa-e", version: 1 },
          {
            type: "text",
            text: " text.",
            detail: 0,
      ...
      },
      {
        ...
        children: [
          ...
          { type: "ms", marker: "zmsa-s", sid: "1", version: 1 },
          {
            type: "mark",
            ids: ["1"],
            direction: null,
          ...
          { type: "ms", marker: "zmsa-s", sid: "2", version: 1 },
          {
            type: "mark",
            ids: ["1", "2"],
            direction: null,
          ...
          { type: "ms", marker: "zmsa-e", eid: "1", version: 1 },
          {
            type: "mark",
            ids: ["2"],
            direction: null,
          ...
          { type: "ms", marker: "zmsa-e", eid: "2", version: 1 },
        ],
      },
      {
        type: "para",
